...
Use mouse scroll wheel to zoom in and make finer adjustments. Do this after moving the measure marker in the previous step first because moving the tempo marker
