...
![Startup view of Arrow Vortex](../../../../assets/images/tempomapping/arrow-vortex-main.png)
...
Next:
    ...
    3. In `Tempo`, click on `Adjust sync...`. You'll be presented with the following menu: 
        ...
        ![The adjust sync menu in AV](../../../../assets/images/tempomapping/arrow-vortex-sync.png)

    4. Click on  `Find BPM`. Shortly after, AV will return one or more results.

        ![Results in the Adjust sync menu of AV](../../../../assets/images/tempomapping/arrow-vortex-results.png)
        ...
        > Furthermore, its' most confident result could have an unrounded value or a slightly incorrect offset. 
        > If the BPM result is, let's say 161.99, then it's most likely safe to round it to 162.  
    ...
    | :---: | :---: |
    | ![Original 1st result returned by AV](../../../../assets/images/tempomapping/arrow-vortex-original-res.png) | ![Adjusted result](../../../../assets/images/tempomapping/arrow-vortex-adj-res.png) |
